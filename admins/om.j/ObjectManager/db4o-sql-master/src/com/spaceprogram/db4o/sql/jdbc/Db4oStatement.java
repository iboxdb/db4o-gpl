...
public class Db4oStatement implements Statement {
    ...
    public long getLargeUpdateCount() throws SQLException {
        return Statement.super.getLargeUpdateCount(); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public void setLargeMaxRows(long l) throws SQLException {
        Statement.super.setLargeMaxRows(l); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long getLargeMaxRows() throws SQLException {
        return Statement.super.getLargeMaxRows(); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long[] executeLargeBatch() throws SQLException {
        return Statement.super.executeLargeBatch(); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long executeLargeUpdate(String string) throws SQLException {
        return Statement.super.executeLargeUpdate(string); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long executeLargeUpdate(String string, int i) throws SQLException {
        return Statement.super.executeLargeUpdate(string, i); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long executeLargeUpdate(String string, int[] ints) throws SQLException {
        return Statement.super.executeLargeUpdate(string, ints); //To change body of generated methods, choose Tools | Templates.
    }

    //@Override
    public long executeLargeUpdate(String string, String[] strings) throws SQLException {
        return Statement.super.executeLargeUpdate(string, strings); //To change body of generated methods, choose Tools | Templates.
    }
}
