...
namespace OMControlLibrary.Common
{
	class Validations
	{
		...
		public static bool ValidateRemoteLoginParams(ref ComboBox comboBoxFilePath, ref TextBox textBoxHost, ref TextBox textBoxPort, ref TextBox textBoxUserName, ref TextBox textBoxPassword)
		{
			try
			{
		...
		public static bool ValidateLocalLoginParams(ref ComboBox comboBoxFilePath, ref TextBox textBoxConnection)
		{
			try
			{
