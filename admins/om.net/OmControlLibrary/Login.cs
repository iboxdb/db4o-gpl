...
using OManager.BusinessLayer.Login;using OME.Logging.Common;
...
namespace OMControlLibrary
{
	...
	public partial class Login: ILoadData
	{
		...
		private const string OPEN_FILE_DIALOG_FILTER = "db4o Database Files(*.db, *.yap, *.db4o)|*.db;*.yap;*.db4o|All Files(*.*)|*.*";
		...
		public static void CreateLoginToolWindow(  Assembly addIn_Assembly	 )
		{
			try
			{
                ...
                loginToolWindow.Width = 600;
                loginToolWindow.Height = 400;
		...
		public static void CreateQueryBuilderToolWindow()
		{
			try
			{
                ...
                queryBuilderToolWindow.Width = 800;
                queryBuilderToolWindow.Height = 950;
	...
	private void radioButton_Click(object sender, EventArgs e)
		...
		private void comboBoxFilePath_DropdownItemSelected(object sender, EventArgs e)
		{
			try
			{
                /*
